...
function loadDemoData() {
  ...
  appData = {
    ...
    repeatIncidents: {
      ...
      periodLabel: "All-time (since Mar 2023)",
      employees: [
...
function renderPrediction(p, cachedAt) {
  ...
  <div class="pred-tab-content active" id="pred-tab-review">
    ...
    <div class="section-header"><div class="section-title">Repeat-incident employee watchlist (${appData.repeatIncidents?.periodLabel || 'All-time'})</div></div>
